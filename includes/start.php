...
$isRead = 0;
if (strtolower($message['text']) == "start" || strtolower($message['text']) == "restart") {
    $a = strval($income - $expense);
...
else if (strtolower($message['text']) == "input")  {
    $income  = $income + 100;
    $a = strval($income - $expense);
    $client->replyMessage(array(
        'replyToken' => $event['replyToken'],
...
if($isRead == 1){
    if (strtolower($message['text']) == "income")  {
        $client->replyMessage(array(
            'replyToken' => $event['replyToken'],
            'messages' => array(
                array(
